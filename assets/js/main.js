/**
* Template Name: IEFF INDIA
* Template URL: https://www.ieffindia.com/
* Author: vagdevi karumuri
* License: https://www.ieffindia.com/license/
*/
!(function($) {
  "use strict";
 ...
 // Testimonials carousel (uses the Owl Carousel library)
  ...
  // Tourism carousel (uses the Owl Carousel library)
 
		$('.tourism-carousel').owlCarousel({
	    loop:true,
	    autoplay: true,
	    margin:30,
	    animateOut: 'fadeOut',
